  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      <div className="mx-4 relative bg-primary010 p-4 rounded-lg shadow-lg text-white001">
        ...
        <h2 className="text-xl font-bold mt-6 mb-8 font-PlayfairDisplay text-hd2mb">Melt Gifts?</h2>
        ...
        <div className="flex justify-between mt-4 gap-6">
          <button onClick={onClose} className="text-center flex-1 border border-primary001 py-4 rounded-lg font-PlayfairDisplay">Cancel</button>
          <button onClick={onMelt} className="text-center flex-1 border border-primary001 py-4 rounded-lg font-PlayfairDisplay bg-white001 text-primary011">Melt</button>
        </div>
      </div>
    </div>
  );
